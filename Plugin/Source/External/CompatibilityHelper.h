...
Class GYClassFromString(NSString* className);
void GYAddClassAsCategory(Class srcClass, Class targetClass);
#define GYAddAsCategoryToClass(targetClass)  GYAddClassAsCategory([self class], targetClass)

#define class(className) YES.boolValue?GYClassFromString([NSString stringWithFormat:@"%s",#className]):0
